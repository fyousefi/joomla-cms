...
?>
<div id="jlexcomment">
	<form action="<?=JUri::base(true).'/index.php?option=com_jlexcomment&view=replacer'?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-left">
				...
				<button type="button" class="btn" title="" onclick="document.getElementById('filter_search').value='';this.form.submit();"><span class="icon-remove"></span></button>
			</div>
		</div>
		<?php else:?>
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort' , JText::_("JCM_CAPTION") , 'r.caption' , $this->lists['order_Dir'] , $this->lists['order']) ?>
					</th>
					<th class="nowrap">
						<?php echo JText::_("JCM_USER_GROUP"); ?>
					</th>
					...
					<th class="nowrap center">
						<?php echo JHTML::_('grid.sort' , JText::_("JCM_PUBLISHED") , 'r.published' , $this->lists['order_Dir'] , $this->lists['order']) ?>
					</th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<?php else: ?>
					<tr>
						<td class="center" colspan="6"><?php echo JText::_("JCM_NO_ITEM"); ?></td>
					</tr>
				<?php endif; ?>
			</tbody>
		</table>
