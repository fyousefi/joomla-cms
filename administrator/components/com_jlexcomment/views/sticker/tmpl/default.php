...
?>
<div id="jlexcomment">
	<form action="<?=JUri::base(true).'/index.php?option=com_jlexcomment&view=sticker'?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th class="nowrap center">
						<?php echo JHtml::_('grid.sort' , JText::_("JCM_GROUP") , 's.group_id' , $this->lists['order_Dir'] , $this->lists['order']) ?>
					</th>
					<th class="nowrap center">
			...
			<tbody>
				<?php if(is_array($this->items) && count($this->items)): ?>
					...
					<tr class="row<?php echo $k ?>">
						...
						<td class="center">
							<a href="<?php echo $item->url2group; ?>"><?php echo $item->group_name ?></a>
						</td>
