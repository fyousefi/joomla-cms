...
?>
<div id="jlexcomment">
	<form action="<?=JUri::base(true).'/index.php?option=com_jlexcomment&view=blacklist'?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th class="nowrap">
						<?php echo JText::_("JCM_OBJECT"); ?>
					</th>
					<th class="nowrap">
						<?php echo JText::_("JCM_REASON"); ?>
					</th>
					<th class="nowrap center">
						<?php echo JHTML::_('grid.sort' , JText::_("JCM_CREATED_BY") , 'bls.created_by' , $this->lists['order_Dir'] , $this->lists['order']) ?>
					</th>
					<th class="nowrap center">
						<?php echo JHTML::_('grid.sort' , JText::_("JCM_CREATED_TIME") , 'bls.created_time' , $this->lists['order_Dir'] , $this->lists['order']) ?>
					</th>
				</tr>
			</thead>
				...
				<?php if(is_array($this->items) && count($this->items)): ?>
					...
					<tr class="row<?php echo $k ?>">
						...
						<td class="has-context">
							<a href="<?php echo $item->url2edit; ?>"><?php echo $item->method_value; ?></a>
							<div class="jcm-text-small">
								<?php echo $item->method_text; ?>
							</div>
						</td>
