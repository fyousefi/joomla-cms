...
<div class="container mt-8">
    <div class="com-users-remind remind row justify-content-center">
        <div class="col-sm-12 col-md-9 col-lg-4 bg-body border border-1 rounded p-0 fs-8">
            ...
            <form id="user-registration" action="<?php echo Route::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="com-users-remind__form form-validate form-horizontal well px-5">
