...
// conditionally apply Bootstrap positioning + overlay utilities
$isFullLayout = (bool) $params->get('fullwidth', 0);
?>

<?php echo LayoutHelper::render('joomla.content.intro_image', $this->item); ?>

<div class="item-content <?php echo $isFullLayout ? ' position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center z-2' : ''; ?>">
    <?php if ($isFullLayout): ?>
    ...
    <?php  echo !$isFullLayout ? $this->item->introtext : ''; ?>
